...
per person to run, and it is covered by 242 unit tests plus a 35-check suite that runs
...
**Testing.** 242 unit tests run in about three seconds with zero API cost (model calls are
